...
function createComment(url, request) {
  ...
  if (requestComment && requestComment.comment && requestComment.comment.body && requestComment.comment.username && database.users[requestComment.comment.username] && database.articles[requestComment.comment.articleId]){
